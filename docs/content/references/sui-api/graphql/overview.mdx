...
An interactive IDE with autocomplete support and built-in documentation is available for [mainnet](https://rpc.mainnet.mystenlabs.com/graphql). 


:::info

The `https://rpc.mainnet.mystenlabs.com/graphql` endpoint is rate-limited to keep network throughput optimized.
