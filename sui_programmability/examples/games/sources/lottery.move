...
module games::lottery {
    ...
    ///
    /// Random is provided as an argument to prevent insertion of calls to 'play' between the time the randomness for
    /// 'determine_winner' is known and the time that call is executed.
    public fun play(game: &mut Game, coin: Coin<SUI>, clock: &Clock, _r: &Random, ctx: &mut TxContext): Ticket {
